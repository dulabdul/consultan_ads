  ...
  return (
    <footer className='w-full overflow-hidden bg-dark px-6 md:px-32 py-12'>
      <div className='container w-full mx-auto'>
        <div className='grid grid-cols-12 md:justify-between lg:justify-center gap-y-6 md:gap-y-0 gap-x-4'>
          <div className='col-start-1 col-end-12 md:col-start-1 md:col-end-7 lg:col-start-1 lg:col-end-7'>
            <img
          ...
          <div className='col-start-1 col-end-12 md:col-start-7 md:col-end-12  lg:col-start-7 lg:col-end-9'>
          ...
          <div className='col-start-1 col-end-12 md:col-start-1 md:col-end-7 lg:col-start-9 lg:col-end-11'>
          ...
          <div className='col-start-1 col-end-12 md:col-start-7 md:col-end-12 lg:col-start-11 lg:col-end-12'>
